...
| Progress | `█░░░░░░░░░░░░░░░░░░░` 6% |
| Streak | `59` day(s) |
| Last Commit (IST) | `2026-09-11 13:46:34 IST` |
...
| Story | Score | 💬 |
| :--- | ---: | ---: |
| [Shopify is moving from React Native back to Swift and Kotlin](https://shopify.engineering/back-to-native) | 844 | 567 |
| [More questions about whether researchers can trust OpenAI with unpublished math](https://mathstodon.xyz/@andreasthom/117240535270608201) | 726 | 667 |
| [Mexican student creates an acoustic fire extinguisher to put out fire in seconds](https://www.upsocl.com/en/16-year-old-mexican-student-creates-an-acoustic-fire-extinguisher-that-uses-sound-waves-to-put-out-fires-in-seconds/) | 70 | 24 |
| [OpenAI Agents API](https://developers.openai.com/api/docs/guides/agents-api/overview) | 166 | 103 |
| [YuE2 · Frontier Music with Symbolic Planning](https://map-yue2.github.io/) | 57 | 47 |
