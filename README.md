...
| Story | Score | 💬 |
| :--- | ---: | ---: |
| [Tether: iMessage, SMS, etc. on Linux](https://zackbartel.com/blog/2026/08/tether/) | 119 | 56 |
| [SQLite as a Document Database (2020)](https://dgl.cx/2020/06/sqlite-json-support) | 96 | 16 |
| [Sleepwalker: Passive Backdoor with Its Own Command Language](https://r136a1.dev/2026/08/24/sleepwalker-a-passive-backdoor-with-its-own-command-language/) | 30 | 1 |
| [Indirect Calling of Nested Functions on GCC Without Executable Stack](https://uecker.codeberg.page/2026-08-29.html) | 47 | 19 |
| [Show HN: Typebase – A single-folder back end you write in TypeScript](https://typebase.io) | 66 | 14 |
